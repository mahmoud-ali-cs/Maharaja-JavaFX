...
public class TakeAwayOrderController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        System.out.println("start ini : orderID : " + orderID);
    ...
    void goToAddOrderDetails(ActionEvent event) throws IOException {
        ...
        AddItemOrderPackage.AddItemOrderController.lastLocation = "/TakeAwayOrderPackage/TakeAwayOrder.fxml" ;
    ...
    void goToBill(ActionEvent event) throws IOException {
        System.out.println("go to bill !!");
        BillPackage.BillController.orderID = this.orderID ;
        BillPackage.BillController.orderDiscount = Double.parseDouble( discountTF.getText() ) ;
        BillPackage.BillController.taxesValue = Double.parseDouble( taxesTF.getText() ) ;
        
        System.out.println("this.orderID : " + this.orderID);
        System.out.println("BillPackage.BillController.orderID : " + BillPackage.BillController.orderID);
