...
public class DeleteShipmentStageController implements Initializable {
...
//        Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","maharaja","123");
    ...
    private void delete_method(ActionEvent event) throws Exception {
        ...
        items_shipment is=new items_shipment(Integer.parseInt(shipment_id.getText()), Integer.parseInt(item_id.getText()));
        is.delete();
